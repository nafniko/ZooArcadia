...
$carousselHabits = [
    ...
    [
        ...
        "savane"=>"https://img-31.ccm2.net/7Ftbm-YitOoUxQazCpaNgfO3344=/910x/smart/d1726c8458804d7584bccb15754e65d1/ccmcms-hugo/25842330.png",
...
$contentServices = [
    ...
    [ 
        ...
        "content"=>"Au Zoo Arcadia, nous mettons à votre disposition plusieurs services pour rendre votre visite inoubliable, tout en respectant notre engagement écologique.

                    Restauration éco-responsable
                    Faites une pause gourmande dans notre espace de restauration, où nous privilégions des produits locaux et biologiques. Profitez de plats savoureux tout en contribuant à la réduction de notre empreinte environnementale.

                    Visites guidées des habitats
                    Explorez les différents habitats du zoo avec un guide expert, gratuitement. Découvrez les espèces animales dans leur environnement recréé, et apprenez-en plus sur leurs comportements et les efforts de conservation.

                    Balade en petit train
                    Montez à bord de notre petit train écologique pour une visite relaxante à travers le zoo. Une manière amusante et tranquille de découvrir tous nos animaux sans trop marcher !",
    ...
    [
        ...
        "content"=>"Nos Restaurants au Zoo Arcadia
                    Lors de votre visite au Zoo Arcadia, profitez d'une expérience culinaire unique grâce à nos trois restaurants thématiques, chacun inspiré par un écosystème naturel.
                    ...
                    Dans la Jungle
                    Entrez dans une ambiance tropicale, où vous pourrez déguster des plats exotiques, riches en fruits et légumes. Ce restaurant est un véritable voyage sensoriel, au milieu d'une végétation luxuriante.", 

        "image"=>"zoo-arcadia-accueil.png",

        "link"=>"/pages/Restaurants.php",
    ], 

    [ 
        "title" =>"Visite guidé des habitats",
        ...
        "link"=>"/pages/visite.php",
        
    ],

    [ 
        "title" =>"Visitez avec le petit train",

        "content"=>"Visite du Zoo en Petit Train
...
$animals = [
    ...
    [
        ...
        "content"=>"À la rencontre des animaux du Zoo Arcadia
