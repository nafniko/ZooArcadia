...
require __DIR__ . '/../utils/route.php';
...
<head>
    ...
    <link rel="stylesheet" href="/ZooArcadia/node_modules/bootstrap/dist/css/bootstrap.min.css">
    <link rel="stylesheet" href="/ZooArcadia/node_modules/bootstrap-icons/font/bootstrap-icons.css">
    <link rel="stylesheet" href="/ZooArcadia/node_modules/bootstrap-icons/font/bootstrap-icons.css">
    <link rel="stylesheet" href="/ZooArcadia/public/scss/main.css">
            ...
            <div id="carouselExampleAutoplaying" class="carousel slide carousel-fade" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active ">
                        <img src="/ZooArcadia/public/asset/header_girafle.jpg" class="myimg"  alt="caroussel girafle">
                    </div>
                    <div class="carousel-item ">
                        <img src="/ZooArcadia/public/asset/header_singes.jpg" class="myimg " alt="caroussel singe">
                    </div>
                    <div class="carousel-item">
                        <img src="/ZooArcadia/public/asset/header_zoo.jpg" class="myimg" alt="caroussel zoo">
                    </div>
                    <div class="carousel-item">
